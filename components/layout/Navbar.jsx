  ...
  return (
    ...
    >
        ...
        <div className={`mx-auto w-full px-5 sm:px-9 md:px-10 xl:px-12 max-w-[1536px] relative flex shrink-0 items-center justify-between transition-colors duration-300 ${
          ...
          <div className="relative z-20 hidden shrink-0 justify-end gap-2 md:flex">
            <a target="_blank" href="https://venture.angellist.com/v/login" className="[&_svg]:[stroke-width-2] inline-flex items-center justify-center gap-2 rounded-sm font-sans text-[1rem] leading-normal tracking-[-0.002em] no-underline transition-colors duration-200 hover:no-underline focus-visible:outline-1 focus-visible:ring-1 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 h-12 px-4 bg-transparent text-surface-text-primary hover:bg-black/10">Sign in</a>
            <Link href="/contact" className="[&_svg]:[stroke-width-2] inline-flex items-center justify-center gap-2 rounded-sm font-sans text-[1rem] leading-normal tracking-[-0.002em] no-underline transition-colors duration-200 hover:no-underline focus-visible:outline-1 focus-visible:ring-1 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 h-12 px-4 bg-purple-2 text-ink-1 hover:bg-cta-primary-bg hover:text-cta-primary-text focus-visible:bg-cta-primary-bg focus-visible:text-cta-primary-text active:bg-cta-primary-bg active:text-cta-primary-text">Contact sales</Link>
          </div>
          <button 
            type="button" 
            onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
            className={`[&_svg]:[stroke-width-2] inline-flex items-center justify-center gap-2 rounded-sm font-sans text-[1rem] leading-normal tracking-[-0.002em] no-underline transition-colors duration-200 hover:no-underline focus-visible:outline-1 focus-visible:ring-1 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 size-10 p-0 hover:bg-black/10 translate-x-2 sm:translate-x-4 md:hidden z-20 ${
              isMobileMenuOpen ? 'text-ink-1 bg-transparent' : 'text-surface-text-primary bg-transparent'
            }`}
          >
            {isMobileMenuOpen ? (
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.25">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
              </svg>
            ) : (
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" stroke="currentColor" strokeWidth="1.25">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="flex flex-col flex-1 bg-white px-5 sm:px-9 overflow-y-auto w-full md:hidden">
            <nav className="flex flex-col w-full">
              <button className="flex justify-between items-center py-5 border-b border-gray-100 text-ink-1 hover:text-purple-700 transition-colors">
                <span className="text-[1rem] font-medium tracking-[-0.002em]">Products</span>
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-500">
                  <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
              <button className="flex justify-between items-center py-5 border-b border-gray-100 text-ink-1 hover:text-purple-700 transition-colors">
                <span className="text-[1rem] font-medium tracking-[-0.002em]">Solutions</span>
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-500">
                  <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
              <Link href="/pricing" className="flex justify-between items-center py-5 border-b border-gray-100 text-ink-1 hover:text-purple-700 transition-colors">
                <span className="text-[1rem] font-medium tracking-[-0.002em]">Pricing</span>
              </Link>
              <button className="flex justify-between items-center py-5 border-b border-gray-100 text-ink-1 hover:text-purple-700 transition-colors">
                <span className="text-[1rem] font-medium tracking-[-0.002em]">Resources</span>
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-500">
                  <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
